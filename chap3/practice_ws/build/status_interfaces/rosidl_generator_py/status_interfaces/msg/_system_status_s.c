...
bool status_interfaces__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // cpu_percent
    ...
    ros_message->cpu_percent = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // memory_percent
    ...
    assert(PyFloat_Check(field));
    ros_message->memory_percent = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // memory_total
    ...
    assert(PyFloat_Check(field));
    ros_message->memory_total = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // memory_available
    ...
    assert(PyFloat_Check(field));
    ros_message->memory_available = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // net_sent
